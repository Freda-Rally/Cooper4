...
//文件保存目录路径
String savePath = request.getServletContext().getRealPath("/") + "filedir/dataupload/kindattached/";

//文件保存目录URL
String saveUrl  = request.getContextPath() + "/filedir/dataupload/kindattached/";
