...
String rootPath = request.getServletContext().getRealPath("/") + "filedir/dataupload/kindattached/";
//根目录URL，可以指定绝对路径，比如 http://www.yoursite.com/attached/
String rootUrl  = request.getContextPath() + "/filedir/dataupload/kindattached/";
//图片扩展名
